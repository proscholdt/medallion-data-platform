...
# Lista de scripts (em ordem) na pasta transformador da Gold
scripts = [
    "01_identificacao_deal_ativo.py",
    "02_flag_ult_moviment.py"
    # Adicione aqui outros scripts conforme for criando na pasta
]
