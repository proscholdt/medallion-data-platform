# # ==========================================================
# # Move todos os blobs .parquet de deal_move → deal_move_carregados (com delete)
# # ==========================================================
...
# DEST_FOLDER = "source_pipedrive/deal_move_carregados"
...
#     # Subir para destino
#     container_client.get_blob_client(dest_blob_name).upload_blob(blob_data, overwrite=True)
...
# ==========================================================
# Move todos os blobs .parquet de deal_move → deal_move_carregados
