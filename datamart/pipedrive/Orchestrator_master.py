...
orchestrators = [
    os.path.abspath(os.path.join("datamart", "pipedrive", "aBronze", "Orchestrador", "1_orchestrator_master_bronzeTOSilver.py")),
    os.path.abspath(os.path.join("datamart", "pipedrive", "bSilver", "Orchestrador", "2_orchestrator_master_silverTOgold.py")),
    os.path.abspath(os.path.join("datamart", "pipedrive", "cGold", "Orchestrador", "3_orchestrator_gold.py"))
]
