...
CAMINHO_BRONZE = "source_google/campanhas"
...
colunas_float = [
    "ctr", "cpc_medio", "custo", "valor_conversao", "conversoes"
]
...
print("🏁 Todos os arquivos de campanhas convertidos e enviados para Silver.")
