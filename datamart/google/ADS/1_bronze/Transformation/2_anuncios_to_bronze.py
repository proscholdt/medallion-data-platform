...
CAMINHO_PASTA_BLOB = "source_google/anuncios"

SHEET_ID = "1doaKLuEuJqu4PFte0lp9nr98MvVkZ1THy5-agzYMF1o"
ABA_DADOS = "resumo_anuncios"
...
# === CONVERTE COLUNA "data" PARA DATE ===
try:
    df = df.with_columns(
...
# === GERA CSV E ENVIA PARA AZURE ===
data_hoje_str = datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
NOME_ARQUIVO_CSV = f"{data_hoje_str}_anuncios.csv"
...
print(f"✅ CSV de anúncios enviado com data {data_max} para: {CONTAINER_NAME}/{CAMINHO_BLOB}")
