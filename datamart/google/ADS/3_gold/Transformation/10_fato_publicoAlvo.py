...
CAMINHO_GOLD = "source_google/fato_publico_alvo"
NOME_ARQUIVO_GOLD = "fato_publico_alvo.parquet"

# Colunas desejadas (ordem obrigatória)
CAMPOS_DESEJADOS = [
    "data", "id_campanha", "id_grupo","id_publico",
    "faixa_idade","genero","faixa_renda","status_parental",
