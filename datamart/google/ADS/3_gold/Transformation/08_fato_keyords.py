...
CAMINHO_GOLD = "source_google/fato_keywords"
NOME_ARQUIVO_GOLD = "fato_keywords.parquet"

# Colunas desejadas (ordem obrigatória)
CAMPOS_DESEJADOS = [
    "data", "palavra_chave", "tipo_correspondencia", "status",
    "criterion_id", "grupo_id", "campanha_id",
...
# if dfs:
#     df_final = pl.concat(dfs, how="vertical")
#     df_final = df_final.select([col for col in CAMPOS_DESEJADOS if col in df_final.columns])
