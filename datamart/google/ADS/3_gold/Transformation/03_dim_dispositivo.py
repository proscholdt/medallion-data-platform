...
CAMINHO_DESTINO = "source_google/dim_dispositivo/dim_dispositivo.parquet"  # Corrigido aqui

# === Campos desejados ===
CAMPOS_DESEJADOS = ["dispositivo", "id_dispositivo"]
...
df = df.select(colunas_presentes).unique()
