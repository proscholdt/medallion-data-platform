...
#     timeout=30
# )
# print(r.json())  # -> {'followers_count': 1234, 'id': '1784...'}


# # seguidores_itvalley_json.py
# import requests
# import json
...
# if resp.status_code == 200 and "followers_count" in data_api:
#     saida = {
#         "pagina": PAGINA_NOME,
#         "data": date.today().isoformat(),
#         "seguidores": data_api["followers_count"]
#     }
# else:
#     saida = {
#         "pagina": PAGINA_NOME,
#         "data": date.today().isoformat(),
#         "seguidores": None,
#         "erro": data_api.get("error", data_api)
#     }
