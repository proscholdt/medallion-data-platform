...
orchestrators = [
    os.path.abspath(os.path.join("datamart", "redes_sociais", "IT_facebook", "seguidores_IT_facebook.py")), 
    os.path.abspath(os.path.join("datamart", "redes_sociais", "IT_facebook", "togold_ITfacebook.py")), 
