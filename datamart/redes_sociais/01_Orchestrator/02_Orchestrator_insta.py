...
orchestrators = [
    os.path.abspath(os.path.join("datamart", "redes_sociais", "instagram", "seguidores_insta.py")), 
    os.path.abspath(os.path.join("datamart", "redes_sociais", "instagram", "toGold.py")), 
