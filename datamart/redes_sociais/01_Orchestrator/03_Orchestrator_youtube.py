...
orchestrators = [
    os.path.abspath(os.path.join("datamart", "redes_sociais", "youtube", "etl_diario_youtube.py")), 
    os.path.abspath(os.path.join("datamart", "redes_sociais", "youtube", "toGold.py")), 
