...
PAGE_ID = os.getenv("FB_PAGE_ID_CARLOSVIANA")

# === Configuração Azure Blob ===
STORAGE_ACCOUNT_NAME = os.getenv("STORAGE_ACCOUNT_NAME")
STORAGE_ACCOUNT_KEY = os.getenv("STORAGE_ACCOUNT_KEY")
CONTAINER_NAME = "bronze"
CAMINHO_DESTINO = "source_redesociais/facebook"
...
resultado = {
    "pagina": "Carlos Viana Informática",
    "data": data_hoje,
    "seguidores": followers
}

# === 4. Enviar para o Azure Blob ===
nome_arquivo = f"seguidores_carlosviana_{data_hoje}.json"
