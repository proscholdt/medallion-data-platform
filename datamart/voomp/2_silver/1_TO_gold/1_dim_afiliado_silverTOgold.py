...
pasta_dim_afiliado = 'source_voomp/dim_afiliado'
nome_dim_afiliado = 'dim_afiliado.parquet'
...
# Upload para a Gold
destino_blob = f"{pasta_dim_afiliado}/{nome_dim_afiliado}"
gold_client.upload_blob(name=destino_blob, data=parquet_buffer, overwrite=True)

print(f"✅ Arquivo dim_afiliado salvo na Gold: {CONTAINER_GOLD}/{destino_blob}")
